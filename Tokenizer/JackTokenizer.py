...
class JackTokenizer:
    ...
    def token(self, word):
        if re.match(self.keywordsRegex, word) != None:
            return ("keyword", word)
        elif re.match(self.symbolsRegex, word) != None:
            return ("symbol", word)
        elif re.match(self.integerRegex, word) != None:
            return ("integerConstant", word)
        elif re.match(self.stringsRegex, word) != None:
